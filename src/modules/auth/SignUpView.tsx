...
export const SignUpView=()=>{
    ...
    return(
      ...
      <div className="bg-white/10 backdrop-blur-lg border bg-gradient-to-br from-orange-400 via-orange-300 to-white border-white/20 rounded-2xl p-8 shadow-2xl">
        <h2 className="text-2xl font-bold text-white text-center mb-8">Continue with</h2>
        ...
        <div className="mt-12">
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-gray-600/20 to-gray-400/20 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </button>
          </div>
        </div>
